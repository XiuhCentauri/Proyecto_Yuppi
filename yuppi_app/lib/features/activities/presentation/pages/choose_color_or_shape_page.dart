...
class ChooseLettersPage extends StatelessWidget {
  const ChooseLettersPage({super.key});
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              // Botón Vocales (toda la tarjeta azul es clickeable)
              Expanded(
                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: const [
                        Image(
                          image: AssetImage(
                            'assets/images/actividades/Vocales.png',
                          ),
